...
func StartAdmin() {
	...
	portalAuth.HandleFunc("/session/disconnect", UserPortalDisconnectSession)
	portalAuth.HandleFunc("/otp/status", UserPortalGetOtpStatus)
	portalAuth.HandleFunc("/otp/bind", UserPortalBindOtp)
	portalAuth.HandleFunc("/otp/confirm", UserPortalConfirmOtp)
	portalAuth.HandleFunc("/otp/reset", UserPortalResetOtp)
	portalAuth.HandleFunc("/otp/recovery_codes", UserPortalRegenerateRecoveryCodes)
	portalAuth.HandleFunc("/bandwidth", UserPortalBandwidthStats)
	portalAuth.HandleFunc("/routes", UserPortalGetRoutes)
